-- Fix ambiguous "match_id" column reference in get_chat_matches (LATERAL subqueries
-- now use explicit msg alias so PL/pgSQL can distinguish the column from the variable).
